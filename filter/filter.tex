...
\begin{boxleft}\bla{Abtastung von Bandpasssignalen}
\des[\Hz]{f_u}{Untere Signalfrequenz}\\
\des[\Hz]{f_o}{Obera Signalfrequenz}\\
\des[\Hz]{f_a}{Abtastfrequenz}
\end{boxleft}\begin{boxrightshaded}
\begin{align*}
...
\begin{boxleft}\bla{Quantisierungsrauschen}
\des[\Hz]{f_u}{Untere Signalfrequenz}\\
\des[\Hz]{f_o}{Obera Signalfrequenz}\\
\des[\Hz]{f_a}{Abtastfrequenz}
\end{boxleft}\begin{boxrightshaded}
